...
import { HeroContentMotion } from "@/components/sections/hero-motion";
...
export function Hero({
      ...
      <div className="mt-8 flex flex-wrap items-center gap-3">
        ...
        {secondaryCta ? (
          <Button
            ...
            variant="outline"
            size="lg"
            className="border-white/40 bg-white/10 text-white hover:bg-white/20 transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
  ...
  const searchAreaNode = searchArea ? (
    <div className="mt-10 w-full max-w-3xl">{searchArea}</div>
  ) : null;
