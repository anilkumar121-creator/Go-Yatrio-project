...
async function main() {
  ...
  const password =
    process.env.ADMIN_PASSWORD ?? process.env.SEED_ADMIN_PASSWORD ?? "ChangeMe.dev.only.123";
  ...
  const destinationSeeds = [
    {
      ...
      metaDescription:
        "Explore Goa beach holidays with GoYatrio. Book customized Goa tour packages, resorts, and cab services at the best prices.",
    },
    {
      slug: "kerala",
      name: "Kerala",
      state: "Kerala",
      shortDescription:
        "God's Own Country with tranquil backwaters, misty hill stations, spice plantations, and Ayurveda wellness.",
      description:
      ...
      metaDescription:
        "Book Kerala tour packages with GoYatrio. Experience backwater houseboats, Munnar tea hills, and Ayurveda wellness retreats.",
    },
    {
      slug: "kashmir",
      name: "Kashmir",
      ...
      metaDescription:
        "Discover Kashmir with GoYatrio. Book Srinagar houseboat stays, Gulmarg excursions, and complete Kashmir holiday packages.",
    },
    {
      slug: "andaman",
      name: "Andaman",
      ...
      shortDescription:
        "Exotic tropical islands with turquoise waters, coral reefs, and pristine white-sand beaches.",
      description:
      ...
      metaDescription:
        "Plan your Andaman island vacation with GoYatrio. Book Havelock beach tours, snorkeling adventures, and island hopping packages.",
    },
    {
      slug: "leh-ladakh",
      name: "Leh Ladakh",
      state: "Ladakh",
      shortDescription:
        "High-altitude desert adventure with dramatic mountain passes, monasteries, and starry skies.",
      description:
      ...
      metaDescription:
        "Book Leh Ladakh tour packages with GoYatrio. Experience Nubra Valley camel safaris, Pangong Tso camping, and Khardung La rides.",
    },
    {
      slug: "rajasthan",
      name: "Rajasthan",
      state: "Rajasthan",
      shortDescription:
        "Land of Kings with royal palaces, majestic desert forts, camel safaris, and rich folk culture.",
      description:
      ...
      metaDescription:
        "Explore Rajasthan with GoYatrio. Book Jaipur, Udaipur, and Jaisalmer heritage tours with royal stays and private transfers.",
    },
  ];
  ...
  const hotelSeeds = [
    {
      ...
      fullDescription:
        "Tea Valley Resort offers executive wooden cottages overlooking lush green valleys. Enjoy morning nature walks, bonfires, traditional Keralite dining, and misty mountain views.",
      ...
      roomTypes: [
        {
          roomName: "Executive Tea View Cottage",
          roomDescription: "Spacious wooden cottage with private balcony facing tea gardens.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "380 sq ft",
          priceFrom: 5500,
        },
        {
          ...
          roomDescription: "Premium suite with panoramic valley view and living room.",
          maxGuests: 4,
    ...
    },
    {
      ...
      shortDescription:
        "Luxury handcrafted wooden houseboat floating through tranquil Alleppey backwaters.",
      fullDescription:
        "Experience authentic Keralite hospitality on an exclusive private houseboat. Includes air-conditioned bedrooms, sun deck, private chef serving fresh seafood, and evening backwater cruises.",
      destinationSlug: "kerala",
      ...
      roomTypes: [
        {
          roomName: "Deluxe AC Bedroom",
          roomDescription: "Air-conditioned bedroom with attached bathroom and large window view.",
          maxGuests: 2,
          bedType: "Double Bed",
          roomSize: "220 sq ft",
          priceFrom: 7500,
        ...
        {
          roomName: "Luxury Glass Houseboat Suite",
          roomDescription: "Upper deck glass-walled suite offering 360-degree backwater views.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "320 sq ft",
          priceFrom: 12000,
    ...
    },
    {
      ...
      shortDescription:
        "Iconic 5-star beachfront heritage resort overlooking Sinquerim Beach in Goa.",
      fullDescription:
        "Built on the ramparts of a 16th-century Portuguese fortress, Taj Fort Aguada blends colonial history with luxury amenities, oceanfront infinity pools, and Jiva Spa treatments.",
      destinationSlug: "goa",
      ...
      roomTypes: [
        {
          ...
          roomDescription:
            "Elegantly furnished room with private balcony overlooking the Arabian Sea.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "420 sq ft",
          priceFrom: 18500,
        ...
        {
          roomName: "Hermitage Villa",
          roomDescription: "Exclusive private villa with plunge pool and private garden.",
          maxGuests: 4,
          bedType: "King Bed",
          roomSize: "850 sq ft",
          priceFrom: 35000,
    ...
    },
    {
      ...
      fullDescription:
        "Calangute Grand features outdoor swimming pools, poolbar shacks, live Goan music evenings, and spacious rooms close to famous night markets and beach shacks.",
      destinationSlug: "goa",
      ...
      roomTypes: [
        {
          roomName: "Deluxe Pool View Room",
          roomDescription: "Comfortable air-conditioned room with pool balcony.",
          maxGuests: 3,
          bedType: "Queen Bed",
          roomSize: "280 sq ft",
          priceFrom: 3800,
    ...
    },
    {
      ...
      shortDescription:
        "Heritage cedarwood houseboat anchored on the serene waters of Dal Lake in Srinagar.",
      fullDescription:
        "Crafted from fragrant cedarwood with hand-carved Kashmir walnut furniture and silk carpets. Enjoy Shikara transfers, traditional Wazwan dinners, and views of Shankaracharya hill.",
      ...
      roomTypes: [
        {
          ...
          roomDescription: "Carved walnut furniture suite with lake-facing balcony.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "350 sq ft",
          priceFrom: 6800,
    ...
    },
    {
      ...
      fullDescription:
        "Surrounded by snow-capped Himalayan peaks, Gulmarg Alpine Resort features heated rooms, indoor spa pools, ski equipment rentals, and fire-lit dining lounges.",
      destinationSlug: "kashmir",
      ...
      roomTypes: [
        {
          roomName: "Heated Snow View Room",
          roomDescription: "Centralized heating room with dramatic views of Apharwat peak.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "400 sq ft",
          priceFrom: 14500,
    ...
    },
    {
      ...
      shortDescription:
        "Converted 19th-century royal Haveli featuring courtyard dining and Rajasthani folk dances.",
      fullDescription:
        "Immerse in royal grandeur with traditional fresco paintings, marble courtyards, rooftop fort views, Ayurvedic massages, and authentic Marwari dining.",
      ...
      roomTypes: [
        {
          roomName: "Heritage Royal Room",
          roomDescription: "Traditional Rajasthani decor with king canopy bed.",
          maxGuests: 3,
        ...
        },
        {
          ...
          roomDescription: "Opulent suite with private terrace view of Jal Mahal.",
          maxGuests: 4,
          bedType: "King Bed",
          roomSize: "700 sq ft",
          priceFrom: 12500,
    ...
    },
    {
      ...
      shortDescription:
        "Boutique lakeside resort offering romantic boat rides and City Palace views.",
      fullDescription:
        "Located on the banks of Lake Pichola, this palace resort offers candlelit dining on floating pontoon decks, rooftop pool lounges, and luxury heritage rooms.",
      destinationSlug: "rajasthan",
      ...
      roomTypes: [
        {
          roomName: "Lakefront Suite",
          roomDescription: "Direct views of Lake Pichola and Taj Lake Palace.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "450 sq ft",
          priceFrom: 16000,
    ...
    },
    {
      ...
      shortDescription:
        "Eco-luxury beach resort hidden inside tropical rainforest at Radhanagar Beach.",
      fullDescription:
        "Constructed with indigenous timber and thatch roofs, Barefoot Resort provides direct beach access, scuba diving center, sea-view cottages, and organic dining.",
      ...
      roomTypes: [
        {
          roomName: "Rainforest Andaman Villa",
          roomDescription: "Eco-friendly wooden villa surrounded by lush foliage.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "500 sq ft",
          priceFrom: 14000,
    ...
    },
    {
      ...
      fullDescription:
        "Conveniently situated near Port Blair harbour, offering comfortable sea-facing rooms, rooftop seafood restaurant, and island hopping travel desk.",
      destinationSlug: "andaman",
      ...
      roomTypes: [
        {
          roomName: "Standard Sea View Room",
          roomDescription: "Comfortable room overlooking Ross Island bay.",
          maxGuests: 2,
          bedType: "Queen Bed",
          roomSize: "260 sq ft",
          priceFrom: 3200,
    ...
    },
    {
      ...
      fullDescription:
        "The Grand Dragon Ladakh features solar heating, handcrafted Tibetan wood carvings, oxygen-enriched rooms, and rooftop views of Stok Kangri mountain range.",
      ...
      roomTypes: [
        {
          ...
          roomDescription: "Solar heated room with panoramic views of Stok Kangri.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "360 sq ft",
          priceFrom: 11500,
    ...
    },
    {
      ...
      fullDescription:
        "Experience starlit nights at 14,000 feet with insulated luxury tents, attached modern bathrooms, heating stoves, and hot meals served in central dining tent.",
      destinationSlug: "leh-ladakh",
      ...
      roomTypes: [
        {
          roomName: "Insulated Luxury Glamping Tent",
          roomDescription: "Double-walled heated tent with private bathroom and lakefront view.",
          maxGuests: 3,
          bedType: "Twin / King Beds",
          roomSize: "300 sq ft",
          priceFrom: 7800,
        },
      ],
    },
    {
      ...
      fullDescription:
        "Surrounded by spice plantations, offering jungle walks, bamboo rafting assistance, traditional Keralite meals, and peaceful green ambiance.",
      destinationSlug: "kerala",
      ...
      roomTypes: [
        {
          roomName: "Deluxe Plantation Room",
          roomDescription: "Cozy balcony room facing spice gardens.",
          maxGuests: 3,
          bedType: "Double Bed",
          roomSize: "270 sq ft",
          priceFrom: 3400,
    ...
    },
    {
      ...
      fullDescription:
        "Wake up to the sound of Lidder River and pine forests. Features wood-paneled rooms, campfire grounds, and trout fishing excursions.",
      destinationSlug: "kashmir",
      ...
      roomTypes: [
        {
          ...
          roomDescription: "Balcony room with direct view of Lidder River.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "300 sq ft",
          priceFrom: 4200,
    ...
    },
    {
      ...
      fullDescription:
        "Situated in the heart of the historic Blue City, featuring rooftop fort-view dining, Rajasthani jharokha windows, and guided fort walks.",
      destinationSlug: "rajasthan",
      ...
      roomTypes: [
        {
          roomName: "Fort View Room",
          roomDescription: "Traditional room with spectacular lit-up view of Mehrangarh Fort.",
          maxGuests: 2,
          bedType: "Queen Bed",
          roomSize: "280 sq ft",
          priceFrom: 3900,
    ...
    },
    {
      ...
      fullDescription:
        "Experience desert magic with sunset camel safaris, jeep dune bashing, Rajasthani Kalbeliya folk dance performances, and starry night camping.",
      destinationSlug: "rajasthan",
      ...
      roomTypes: [
        {
          roomName: "Swiss Royal Desert Tent",
          roomDescription: "Carpeted tent with modern attached bathroom and evening cultural show.",
          maxGuests: 3,
          bedType: "Double Bed",
          roomSize: "320 sq ft",
          priceFrom: 5500,
    ...
    },
    {
      ...
      fullDescription:
        "Enjoy sunset cocktails, sea breezes, infinity plunge pools, and spacious modern suites right on Candolim coastline.",
      destinationSlug: "goa",
      ...
      roomTypes: [
        {
          ...
          roomDescription: "Modern suite with direct balcony view of Arabian Sea.",
          maxGuests: 3,
          bedType: "King Bed",
          roomSize: "420 sq ft",
          priceFrom: 9200,
    ...
    },
    {
      ...
      shortDescription:
        "Rejuvenating Ayurveda wellness retreat overlooking Lighthouse Beach Kovalam.",
      fullDescription:
        "Authentic doctor-guided Ayurvedic treatments, yoga pavilions, vegetarian satvik dining, and cliffside ocean views.",
      destinationSlug: "kerala",
      ...
      roomTypes: [
        {
          roomName: "Ayurveda Ocean Cottage",
          roomDescription: "Seafacing cottage designed for peaceful wellness stays.",
          maxGuests: 2,
          bedType: "King Bed",
          roomSize: "350 sq ft",
          priceFrom: 7200,
    ...
    },
    {
      ...
      fullDescription:
        "Set among apple and apricot orchards near Hunder sand dunes and Diskit Monastery. Features organic farm dining and camel safari assistance.",
      destinationSlug: "leh-ladakh",
      ...
      roomTypes: [
        {
          roomName: "Orchard Cottage Room",
          roomDescription: "Wooden room surrounded by organic fruit orchards.",
          maxGuests: 3,
    ...
    },
    {
      ...
      fullDescription:
        "Perfect for budget travelers and backpackers wanting quiet palm groves, clean air-conditioned rooms, and quick beach access.",
      destinationSlug: "goa",
      ...
      roomTypes: [
        {
          roomName: "Standard AC Room",
          roomDescription: "Basic air-conditioned room with private bathroom.",
          maxGuests: 2,
          bedType: "Double Bed",
          roomSize: "200 sq ft",
          priceFrom: 1800,
  ...
  const cabSeeds = [
    {
      ...
      description:
        "Comfortable AC sedan perfect for local city rides, airport transfers, and short one-way trips.",
      capacity: 4,
      luggageCapacity: 2,
      ac: true,
      ...
      tripTypes: [
        CabTripType.LOCAL,
        CabTripType.AIRPORT_TRANSFER,
        CabTripType.RAILWAY_TRANSFER,
        CabTripType.ONE_WAY,
      ],
      featured: true,
    ...
    },
    {
      ...
      description:
        "Spacious 7-seater SUV ideal for family outstation trips, hill routes, and round trips.",
      capacity: 7,
      luggageCapacity: 4,
      ac: true,
      ...
      tripTypes: [
        CabTripType.LOCAL,
        CabTripType.OUTSTATION,
        CabTripType.ONE_WAY,
        CabTripType.ROUND_TRIP,
        CabTripType.MULTI_DAY,
      ],
      featured: true,
      status: CabStatus.ACTIVE,
      destinationSlug: "rajasthan",
    ...
    },
    {
      ...
      description:
        "Premium luxury SUV with plush interiors, large boot space, and advanced safety for executive travel.",
      capacity: 6,
      luggageCapacity: 4,
      ac: true,
      fuelType: CabFuelType.DIESEL,
    ...
    },
    {
      ...
      description:
        "Comfortable 12-seater tempo traveller for group travel, hill trips, and multi-day tours.",
      capacity: 12,
      luggageCapacity: 8,
      ac: true,
      fuelType: CabFuelType.DIESEL,
    ...
    },
    {
      ...
      description:
        "Luxury 17-seater mini bus with recliner seats, ample luggage space, and premium interiors for big groups.",
      capacity: 17,
      luggageCapacity: 12,
      ac: true,
      fuelType: CabFuelType.DIESEL,
    ...
    },
    {
      ...
      description:
        "Economical and agile hatchback perfect for city runs and short outstation commutes.",
      capacity: 4,
      luggageCapacity: 2,
      ac: true,
      fuelType: CabFuelType.PETROL,
    ...
    },
    {
      ...
      vehicleType: VehicleType.SUV,
      description:
        "Rugged 7-seater SUV built for Ladakh, hill stations, and long outstation road trips.",
      capacity: 7,
      luggageCapacity: 5,
      ac: true,
      fuelType: CabFuelType.DIESEL,
    ...
    },
    {
      ...
      vehicleType: VehicleType.HATCHBACK,
      description:
        "Eco-friendly electric hatchback for clean, quiet city travel and airport transfers.",
      capacity: 4,
      luggageCapacity: 2,
      ac: true,
  ...
  const blogAuthors = [
    {
      slug: "goyatrio-editorial",
      name: "GoYatrio Editorial",
      bio: "Official travel editorial team of GoYatrio.",
      role: "Editor",
      avatar: "",
    },
    {
      slug: "ananya-sharma",
      name: "Ananya Sharma",
      bio: "Travel writer covering Kerala, backwaters, and wellness retreats.",
    ...
    },
    {
      slug: "vikram-singh",
      name: "Vikram Singh",
      bio: "Adventure travel journalist focused on Ladakh, trekking, and road trips.",
    ...
    },
    {
      slug: "meera-nair",
      name: "Meera Nair",
      bio: "Food and culture writer exploring Indian heritage destinations.",
      role: "Culture Writer",
      avatar: "",
    },
  ];
  ...
  const blogCategorySeeds = [
    {
      ...
      description: "In-depth travel guides to India's best destinations.",
    },
    {
      slug: "travel-tips",
      name: "Travel Tips",
      description: "Packing lists, planning advice, and smart travel hacks.",
    },
    {
      slug: "packages",
      name: "Packages & Deals",
      description: "Highlights of curated GoYatrio holiday packages.",
    },
    {
      slug: "experiences",
      name: "Experiences",
      description: "Signature stays, cruises, and memorable activities.",
    },
  ];
  ...
  const blogSeeds = [
    {
      ...
      excerpt:
        "Everything you need to know about Alleppey houseboats, from itineraries to food and budget tips.",
      ...
      faq: [
        {
          question: "What is the best time for a Kerala houseboat trip?",
          answer: "September to March offers pleasant weather and calm backwaters.",
        },
        {
    ...
    },
    {
      ...
      excerpt:
        "A dreamy 6-day Kashmir itinerary featuring Dal Lake shikara rides, Gulmarg gondolas, and Pahalgam valleys.",
      ...
      featuredImage:
        "https://images.unsplash.com/photo-1609167830220-7164aa360951?auto=format&fit=crop&w=1200&q=80",
      featured: true,
      status: BlogStatus.PUBLISHED,
    ...
    },
    {
      ...
      excerpt:
        "Explore royal forts, lake palaces, and desert culture on the classic Golden Triangle route.",
  ...
  for (const seed of blogSeeds) {
    ...
    const linkedPackage = seed.packageSlug
      ? await prisma.tourPackage.findUnique({ where: { slug: seed.packageSlug } })
      : null;
  ...
  // === Phase 15: Lookup Tables Seeding ===
  const lookupSeed: {
    key: string;
    name: string;
    description?: string;
    items: { label: string; value: string; sortOrder?: number; icon?: string; color?: string }[];
  }[] = [
    {
      ...
      items: [
        ...
        { label: "Backwaters", value: "BACKWATERS" },
      ],
    },
    {
      key: "PACKAGE_TYPE",
    ...
    },
    {
      ...
      items: [
        { label: "Free High-Speed Wi-Fi", value: "FREE_WIFI", icon: "Wifi" },
        { label: "Swimming Pool", value: "POOL", icon: "Waves" },
        { label: "Ayurveda & Wellness Spa", value: "SPA", icon: "Sparkles" },
        { label: "Multi-Cuisine Restaurant", value: "RESTAURANT", icon: "Utensils" },
        { label: "Fitness Center / Gym", value: "GYM", icon: "Dumbbell" },
        { label: "24/7 Room Service", value: "ROOM_SERVICE", icon: "Clock" },
        { label: "Free Airport Transfer", value: "AIRPORT_TRANSFER", icon: "Car" },
        { label: "Beach Access", value: "BEACH_ACCESS", icon: "Sun" },
      ],
    },
    {
      key: "HOTEL_CATEGORY",
      ...
      items: [
        { label: "Budget", value: "BUDGET", color: "#16a34a" },
        { label: "Standard", value: "STANDARD", color: "#2563eb" },
        { label: "Premium", value: "PREMIUM", color: "#9333ea" },
        { label: "Luxury", value: "LUXURY", color: "#b45309" },
      ],
    },
    {
      key: "VEHICLE_TYPE",
      ...
      items: [
        ...
        { label: "Tempo Traveller", value: "TEMPO_TRAVELLER" },
    ...
    },
    {
      ...
      items: [
        { label: "Destination Guides", value: "DESTINATION_GUIDES" },
        { label: "Travel Tips", value: "TRAVEL_TIPS" },
        { label: "Packages & Deals", value: "PACKAGES" },
    ...
    },
    {
      ...
      items: [
        { label: "Package Inquiry", value: "PACKAGE" },
        { label: "Hotel Inquiry", value: "HOTEL" },
        { label: "Cab Inquiry", value: "CAB" },
        { label: "Contact Form", value: "CONTACT" },
        { label: "Blog CTA", value: "BLOG" },
      ],
    },
    {
      key: "CONTACT_REASON",
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Villa", value: "VILLA" },
        { label: "Houseboat Cabin", value: "HOUSEBOAT_CABIN" },
      ],
    },
    {
      key: "TRANSPORT_TYPE",
      ...
      items: [
        { label: "Private AC Sedan", value: "AC_SEDAN" },
        { label: "Private SUV", value: "SUV" },
        { label: "Tempo Traveller", value: "TEMPO_TRAVELLER" },
        { label: "Coach / Bus", value: "COACH" },
    ...
    },
    {
      ...
      name: "Meal Plans",
      items: [
        { label: "Breakfast Only", value: "CP" },
        { label: "Breakfast & Dinner", value: "MAP" },
        { label: "All Meals", value: "AP" },
        { label: "European Plan (Room Only)", value: "EP" },
      ],
    },
    {
  ...
  for (const groupSeed of lookupSeed) {
    const group = await prisma.lookupGroup.upsert({
      where: { key: groupSeed.key },
      update: { name: groupSeed.name, description: groupSeed.description },
      create: { key: groupSeed.key, name: groupSeed.name, description: groupSeed.description },
    });
